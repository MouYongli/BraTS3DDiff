...
if __name__ == "__main__":
    ...
    pred_labels_path = "/home/students/sanyal/Master-Thesis/Projects/BraTS3DDiff/logs/bratseg_logs/patch_diffusion/BraTS23-PatchDiffusion-PatchSize=32-Random_Subset_Patches/predict/runs/2025-02-05_17-25-27/seg_masks/32"
    eval_images_path = (
        "/home/students/sanyal/Master-Thesis/Projects/BraTS3DDiff/data/BraTS-Data/BraTS2023-GLI/test"
    )
    syn_eval_id = "9615339"
    now = datetime.now()
    zip_file_name = f"BraTS23-PatchDiffusion-PatchSize_32-Random_Subset_Patches-sw_overlap_0_5"
    name = zip_file_name
    team = None
