...
class PatchTumorDiffusionLitModule(LightningModule):
    ...
    def model_step(self, batch) -> th.Tensor:
        ...
        loss_dict['loss'] = loss_dict['patch_classify_loss'] + loss_dict[f"deno_loss"] + loss_dict['seg_loss'] + loss_dict['masked_seg_loss'] + loss_dict[f"seg_consistency_loss"] + loss_dict[f"masked_seg_consistency_loss"]
        return loss_dict
