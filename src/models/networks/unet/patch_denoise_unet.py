...
class PatchDenoiseUNet(nn.Module):
    ...
    def __init__(
        ...
        #4=num of mg channels
        self.up1 = Up(spatial_dims, 1, 4, act, norm, bias, dropout, upsample)
        self.up2 = Up(spatial_dims, 4, 4, act, norm, bias, dropout, upsample)
